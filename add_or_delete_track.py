...
def delete_track_in_data_base(position):
    ...
    track_name_to_delete = cutk.CTkEntry(content_frame, placeholder_text='Track Name', text_color='black',
                            placeholder_text_color='gray', font=('Segoe UI', 15), height=34, width=220, corner_radius=14, border_color='#1976d2', border_width=2)
    track_name_to_delete.grid(row=0, column=0, padx=18, pady=(22, 8), sticky='ew')
